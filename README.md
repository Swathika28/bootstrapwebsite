...
<body>
    <div class="container">
        <div class="row">
            <img src="https://bprd.nic.in/images/GY1.jpg"   style="height:300px;"  alt="police">
            <nav class="navbar navbar-expand-sm bg-light navbar-light">
                <div class="container">
                    ...
                    <form class=" d-flex">
                        ...
                        <button class="btn btn-success " type="button" style="width: 200px; height: 40px">Search</button>
                      </form>
                </div>
              </nav>
            ...
            <table class="table">
                ...
                <tbody>
                    <tr scope="row"></tr>
                    <td class="col-sm-3 h3 bg-secondary bg-gradient">1</td>
                    <td class="col-sm-9 h3 bg-light bg-gradient">Evolution of BPRD</td>
    
                </tbody>
                <tbody>
                    <tr scope="row"></tr>
                    <td class=" col-sm-3 h3 bg-secondary bg-gradient">2</td>
                    <td class=" col-sm-9 h3 bg-light bg-gradient">Awards/Medals</td>
                </tbody>
                <tbody>
                    <tr scope="row"></tr>
                    <td class=" col-sm-3 h3 bg-secondary bg-gradient">3</td>
                    <td class=" col-sm-9 h3 bg-light bg-gradient">Organization</td>
                </tbody>
            <tbody>
                <tr scope="row"></tr>
                <td class="col-sm-3 h3 bg-secondary bg-gradient">4</td>
                <td class="col-sm-9 h3 bg-light bg-gradient">Work Allocation</td>
            </tbody>
            <tbody>
                <tr scope="row"></tr>
                <td class=" col-sm-3 h3 bg-secondary bg-gradient">5</td>
                <td class=" col-sm-9 h3 bg-light bg-gradient">Draft Legislation</td>
            </tbody>
            <tbody>
                <tr scope="row"></tr>
                <td class=" col-sm-3 h3 bg-secondary bg-gradient">6</td>
                <td class=" col-sm-9 h3 bg-light bg-gradient">Citizen Corner</td>
            </tbody>
    ...
    <div class="copyright">
      ...
      <div class="credits">
        Designed by <a href="https://bootstrapmade.com/">Swathika G</a>
      </div>
    </div>
  </footer><!-- End Footer -->
            </div>
...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-2 h2  bg-info "><a href="/static/pageone.html">HOME</a></div>
            <div class="col-sm-2 h2  bg-info"><a href="/static/pagetwo.html">ABOUT US</a></div>
            <div class="col-sm-2 h2  bg-info bg-gradient"><a href="/static/pagethree.html">GALLERY</a></div>
            <div class="col-sm-2 h2  bg-info bg-gradient"><a href="/static/pagefour.html">TRAINING</a></div>
            <div class="col-sm-2 h2  bg-info bg-gradient"><a href="/static/pagefive.html">ADMIN</a></div>
...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-2 h2  bg-light "><a href="/static/pageone.html">HOME</a></div>
            <div class="col-sm-2 h2  bg-light"><a href="/static/pagetwo.html">ABOUT US</a></div>
            <div class="col-sm-2 h2  bg-light bg-gradient"><a href="/static/pagethree.html">GALLERY</a></div>
            <div class="col-sm-2 h2  bg-light bg-gradient"><a href="/static/pagefour.html">TRAINING</a></div>
            <div class="col-sm-2 h2  bg-light bg-gradient"><a href="/static/pagefive.html">ADMIN</a></div>
            <div class="col-sm-2 h2  bg-light bg-gradient"><a href="/static/contactus.html">CONTACT US</a></div>
